...
class AndersonVaninPage extends StatelessWidget {
  ...
  final String email = "anderson.vanin@etec.sp.gov.br";

  const AndersonVaninPage({super.key});
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'lib/assets/equipe/anderson.png',
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Professor de Tecnologia e Especialista em IA',
                        style: GoogleFonts.inter(
                          fontSize: screenWidth * 0.048,
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
